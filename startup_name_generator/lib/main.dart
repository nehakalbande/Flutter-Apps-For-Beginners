...
class _RandomWordsState extends State<RandomWords> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: Text("You should add exactly 4 favorites"),
                        actions: [
                          TextButton(
                            child: Text('OK'),
                            onPressed: () {
      ...
      appBar: AppBar(
        title: Text('Unlimited Keywords Generator'),
        centerTitle: true,
        actions: [
                ...
                children: [
                    ...
                    front: Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage('assets/it1.jfif'),
                          fit: BoxFit.fill,
                        ),
                      ),
                      height: 200,
                  ...
                  FlipCard(
                    front: Container(
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: AssetImage('assets/it2.jfif'),
                          fit: BoxFit.fill,
                        ),
                      ),
                      height: 200,
              ...
              Row(//ROW 2
                ...
                FlipCard(
                  ...
                  front: Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/it3.jfif'),
                        fit: BoxFit.fill,
                      ),
                    ),
                    height: 200,
                ...
                FlipCard(
                  front: Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/it4.jfif'),
                        fit: BoxFit.fill,
                      ),
                    ),
                    height: 200,
