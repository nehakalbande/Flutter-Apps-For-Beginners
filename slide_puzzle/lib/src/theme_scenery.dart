...
class ThemeScenery extends SharedTheme {
  @override
  String get name => 'Scenery';
  ...
  @override
  AssetImage get bkgImage => const AssetImage('asset/Scenery.jpg');
  ...
  Widget tileButton(int i, PuzzleProxy puzzle, bool small) {
    ...
    final decorationImage = DecorationImagePlus(
        ...
        pieceIndex: i,
        fit: BoxFit.cover,
        image: const AssetImage('asset/Scenery.jpg'));
